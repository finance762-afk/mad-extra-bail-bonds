<?php
/**
 * services/dui-bail-bonds/index.php — DUI Bail Bonds Service Page
...
$pageTitle       = 'DUI Bail Bonds in South Florida | Mad Extra Bail Bonds | 24/7 Fast Release';
$pageDescription = 'DUI arrested in South Florida? Mad Extra Bail Bonds posts DUI bail at any Palm Beach, Broward, or Miami-Dade jail 24/7. Licensed FL bondsman — fast DUI bail bond release.';
$canonicalUrl    = $siteUrl . '/services/dui-bail-bonds/';
$currentPage     = 'services';

$_breadcrumb = generateBreadcrumbSchema([
    ['name' => 'Home',     'url' => $siteUrl . '/'],
    ['name' => 'Services', 'url' => $siteUrl . '/services/'],
    ['name' => 'DUI Bail Bonds', 'url' => $siteUrl . '/services/dui-bail-bonds/'],
]);

$_serviceSchema = [
    '@context'    => 'https://schema.org',
    '@type'       => 'Service',
    '@id'         => $siteUrl . '/services/dui-bail-bonds/#service-dui-bail-bonds',
    'name'        => 'DUI Bail Bonds',
    'description' => 'DUI arrested in South Florida? Mad Extra Bail Bonds posts DUI bail at any Palm Beach, Broward, or Miami-Dade jail 24/7. Licensed FL bondsman — fast DUI bail bond release.',
    'url'         => $siteUrl . '/services/dui-bail-bonds/',
    'provider'    => ['@id' => $siteUrl . '/#localbusiness'],
    'areaServed'  => [
        ['@type' => 'State', 'name' => 'Florida'],
        ['@type' => 'City',  'name' => 'Delray Beach, FL'],
    ],
    'serviceType' => 'DUI Bail Bonds',
];

$_faqs = [
    [
        'q' => 'Why is there a mandatory hold for DUI arrests in Florida?',
        'a' => 'Florida law (Section 316.193) requires that anyone arrested for DUI be held until they are no longer under the influence of alcohol or drugs, or for a minimum of 8 hours — whichever period is longer. This hold is mandatory and cannot be waived. No amount of money or legal representation can circumvent this requirement. The hold clock starts from the moment of arrest, not booking.',
    ],
    [
        'q' => 'Can you post a DUI bail bond in Broward County at night?',
        'a' => 'Yes. Mad Extra Bail Bonds operates 24 hours a day across all of Broward County, including the Broward County Main Jail in Fort Lauderdale and all city lockups in Pompano Beach, Coral Springs, Deerfield Beach, Hollywood, and Margate. DUI arrests happen at all hours — we are available at all hours to respond.',
    ],
    [
        'q' => 'Will a DUI bail bond get revoked if the defendant drives after release?',
        'a' => 'The judge sets specific conditions of release at the bond hearing. Common DUI release conditions include prohibition on driving, installation of an ignition interlock device, or use of a ride-share. Violating those conditions can result in bond revocation and re-arrest. We review all conditions with defendants and co-signers at the time of release.',
    ],
    [
        'q' => 'How is DUI bail different from other criminal bail bonds in South Florida?',
        'a' => 'The key differences are the mandatory 8-hour hold before bail can be posted, the sobriety requirement at the facility before release, and the fact that bond conditions for DUI often include driving restrictions. The 10% Florida premium rate still applies. Mad Extra Bail Bonds is familiar with all of these DUI-specific procedures and handles them efficiently.',
    ],
];
...
<style>
/* ============================================================
   DUI BAIL BONDS SERVICE PAGE — Mad Extra Bail Bonds
...
<!-- ═══ HERO ═══ -->
<section class="hero-sp" aria-label="DUI Bail Bonds services">
  ...
  <div class="container">
    <div class="hero-sp-inner">
      <div class="hero-sp-left">
        ...
        <h1>DUI Bail Bonds in South Florida — Fast Release After a DUI Arrest</h1>
        <p class="hero-answer">A DUI arrest in South Florida means a mandatory hold before bail can be set. Mad Extra Bail Bonds knows the DUI bail timeline at every Palm Beach, Broward, and Miami-Dade facility — we are ready to move the moment the court sets bail, day or night.</p>
...
<section class="intro-sp" aria-label="DUI Bail Bonds overview">
  <div class="container">
    <div class="intro-sp-inner">
      <span class="sp-section-eyebrow">About This Service</span>
      <h2 class="intro-h2">How long does it take to get someone out on a DUI bail bond in Florida?</h2>
      <div class="answer-block">
        <p>Florida law requires DUI arrestees to be held until they are sober or for a minimum of 8 hours from the arrest, whichever comes first. After that hold expires and bail is set, release through Mad Extra typically happens within 2 to 6 additional hours. We monitor the case from the moment you call so we are ready to post bond immediately.</p>
      </div>
...
<!-- ═══ PROCESS SECTION ═══ -->
<section class="process-sp" aria-label="DUI Bail Bonds process">
  <div class="container">
    <div class="process-sp-grid">
      ...
      <div>
        <div class="process-sp-header">
          ...
          <h2 class="process-h2-sp">How much does a DUI bail bond cost in Palm Beach or Broward County?</h2>
          <div class="answer-block-dark">
            <p>DUI bail amounts in South Florida typically range from $500 to $5,000 for a first-offense DUI with no accidents or injuries. At Florida's fixed 10% premium rate, that means $50 to $500 in bond premium. Aggravated DUI charges involving injury, death, or a minor in the vehicle carry significantly higher bail amounts and more complex conditions.</p>
          </div>
        </div>
        <div class="process-steps-sp">
          <div class="process-step-sp">
            ...
            <div class="step-content-sp">
              <h4>Call Immediately After Arrest</h4>
              <p>Don't wait for the hold period to end. Call us right away — we gather information, verify the arrest, and position ourselves to post bond the moment the hold lifts.</p>
            </div>
          </div>
          <div class="process-step-sp">
            <div class="step-num-sp">2</div>
            <div class="step-content-sp">
              <h4>We Monitor the Mandatory Hold</h4>
              <p>Florida requires DUI defendants to remain held for 8 hours or until sober. We track the timeline for you and know when the facility will accept our bond.</p>
            </div>
          </div>
          <div class="process-step-sp">
            <div class="step-num-sp">3</div>
            <div class="step-content-sp">
              <h4>Bond Set & Paperwork Signed</h4>
              <p>Once bail is set (either by a judge or on the bond schedule), we present the 10% premium, collect signatures, and post the bond with the jail.</p>
            </div>
          </div>
          <div class="process-step-sp">
            <div class="step-num-sp">4</div>
            <div class="step-content-sp">
              <h4>Release Processing & Court Dates</h4>
              <p>After bond is posted, release processing begins. We also remind your loved one of upcoming court dates — missing a DUI hearing leads to bond forfeiture and a new warrant.</p>
            </div>
          </div>
        </div>
      </div>
...
<!-- ═══ BENEFITS SECTION ═══ -->
<section class="benefits-sp" aria-label="DUI Bail Bonds benefits">
  <div class="container">
    <div class="benefits-sp-header">
      <span class="sp-section-eyebrow">Why Choose Us</span>
      <h2 class="benefits-h2">Why use Mad Extra Bail Bonds for a DUI arrest in South Florida?</h2>
    ...
    <div class="benefits-grid">
        <div class="benefit-card">
          ...
          <h4>Know the DUI Hold Timeline</h4>
          <p>We track the 8-hour mandatory hold so you're not guessing when bail will be accepted.</p>
        </div>
        <div class="benefit-card">
          <div class="bc-icon">
            <?php echo lucide_icon('car'); ?>
          </div>
          <h4>All DUI Charge Levels</h4>
          <p>First offense, second offense, DUI with property damage, aggravated DUI — all charge levels handled.</p>
        </div>
        <div class="benefit-card">
          <div class="bc-icon">
            <?php echo lucide_icon('landmark'); ?>
          </div>
          <h4>All South FL DUI Jails</h4>
          <p>Palm Beach County Jail, Broward County Main Jail, and Miami-Dade facilities — we know all of them.</p>
        </div>
        <div class="benefit-card">
          <div class="bc-icon">
            <?php echo lucide_icon('shield-check'); ?>
          ...
          <p>Over 11 years posting DUI bonds in South Florida — no surprises, no delays from our side.</p>
        </div>
        <div class="benefit-card">
          <div class="bc-icon">
          ...
          <p>We start the process the moment you call, not after the hold expires.</p>
        </div>
        <div class="benefit-card">
          <div class="bc-icon">
            <?php echo lucide_icon('users'); ?>
          ...
          <p>We explain the entire DUI bail process clearly so families understand what to expect.</p>
        </div>
    </div>
  </div>
</section>
...
<!-- ═══ FAQ SECTION ═══ -->
<section class="faq-sp" aria-label="DUI Bail Bonds frequently asked questions">
  <div class="container">
    <div class="faq-sp-inner">
      <span class="sp-section-eyebrow">Common Questions</span>
      <h2 class="faq-h2-sp">Frequently asked questions about <em>dui bail bonds in South Florida</em></h2>
      ...
      <div class="faq-list-sp" role="list">
        <div class="faq-item-sp" role="listitem">
          <button class="faq-q-sp" aria-expanded="false" onclick="toggleFaq(this)">
            <?php echo htmlspecialchars("Why is there a mandatory hold for DUI arrests in Florida?"); ?>
            <span class="faq-icon-sp" aria-hidden="true">+</span>
          </button>
          <div class="faq-a-sp" role="region">
            <p><?php echo htmlspecialchars("Florida law (Section 316.193) requires that anyone arrested for DUI be held until they are no longer under the influence of alcohol or drugs, or for a minimum of 8 hours — whichever period is longer. This hold is mandatory and cannot be waived. No amount of money or legal representation can circumvent this requirement. The hold clock starts from the moment of arrest, not booking."); ?></p>
          </div>
        </div>
        <div class="faq-item-sp" role="listitem">
          <button class="faq-q-sp" aria-expanded="false" onclick="toggleFaq(this)">
            <?php echo htmlspecialchars("Can you post a DUI bail bond in Broward County at night?"); ?>
            <span class="faq-icon-sp" aria-hidden="true">+</span>
          </button>
          <div class="faq-a-sp" role="region">
            <p><?php echo htmlspecialchars("Yes. Mad Extra Bail Bonds operates 24 hours a day across all of Broward County, including the Broward County Main Jail in Fort Lauderdale and all city lockups in Pompano Beach, Coral Springs, Deerfield Beach, Hollywood, and Margate. DUI arrests happen at all hours — we are available at all hours to respond."); ?></p>
          </div>
        </div>
        <div class="faq-item-sp" role="listitem">
          <button class="faq-q-sp" aria-expanded="false" onclick="toggleFaq(this)">
            <?php echo htmlspecialchars("Will a DUI bail bond get revoked if the defendant drives after release?"); ?>
            <span class="faq-icon-sp" aria-hidden="true">+</span>
          </button>
          <div class="faq-a-sp" role="region">
            <p><?php echo htmlspecialchars("The judge sets specific conditions of release at the bond hearing. Common DUI release conditions include prohibition on driving, installation of an ignition interlock device, or use of a ride-share. Violating those conditions can result in bond revocation and re-arrest. We review all conditions with defendants and co-signers at the time of release."); ?></p>
          </div>
        </div>
        <div class="faq-item-sp" role="listitem">
          <button class="faq-q-sp" aria-expanded="false" onclick="toggleFaq(this)">
            <?php echo htmlspecialchars("How is DUI bail different from other criminal bail bonds in South Florida?"); ?>
            <span class="faq-icon-sp" aria-hidden="true">+</span>
          </button>
          <div class="faq-a-sp" role="region">
            <p><?php echo htmlspecialchars("The key differences are the mandatory 8-hour hold before bail can be posted, the sobriety requirement at the facility before release, and the fact that bond conditions for DUI often include driving restrictions. The 10% Florida premium rate still applies. Mad Extra Bail Bonds is familiar with all of these DUI-specific procedures and handles them efficiently."); ?></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="rs-grid">
        <article class="rs-card t1">
          <div class="rs-card-banner">
            <div class="rs-icon-ring">
              <?php echo lucide_icon('shield'); ?>
            </div>
          </div>
          <div class="rs-card-body">
            <h3>Bail Bond Services</h3>
            <p>Fast bail bond services for any criminal charge, 24 hours a day.</p>
            <a href="/services/bail-bonds/" class="rs-link">Learn more <?php echo lucide_icon('arrow-right'); ?></a>
          </div>
        </article>
        ...
        <article class="rs-card t3">
          ...
          <div class="rs-card-body">
            ...
            <p>Bail bonds for drug possession, trafficking, and related charges.</p>
            <a href="/services/drug-charge-bail-bonds/" class="rs-link">Learn more <?php echo lucide_icon('arrow-right'); ?></a>
          </div>
        </article>
    </div>
  </div>
...
<section class="cta-sp" aria-label="Emergency contact">
  <div class="cta-sp-inner">
    <h2>Need a <em>dui bail bonds bondsman</em> right now?</h2>
