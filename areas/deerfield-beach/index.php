...
$_faqs = [
    ...
    [
        ...
        'a' => 'Mad Extra Bail Bonds is based in Delray Beach, approximately 8 miles north of Deerfield Beach on I-95. We are the closest licensed bondsman to Deerfield Beach in our network and can respond faster than agencies operating out of Fort Lauderdale, which is an additional 15 miles south. Our proximity to the Broward-Palm Beach county line means North Broward County — including Deerfield Beach — is our primary coverage zone and gets our fastest response.',
    ],
];
